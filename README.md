...
**GitHub Pages**: [Your deployment URL will go here]
...
1. **Create a new repository** on GitHub
   ...
   - Name it something like `sofia-transport-map`
   - Make it Public
...
3. **Enable GitHub Pages**
   ...
   - Click Save
   - Your site will be live at: `https://[your-username].github.io/sofia-transport-map/`
...
git remote add origin https://github.com/YOUR-USERNAME/sofia-transport-map.git
